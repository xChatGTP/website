...
export interface MockDotRegistryInterface extends utils.Interface {
  functions: {
...
export interface MockDotRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockDotRegistryInterface;
